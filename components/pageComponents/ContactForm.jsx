...
const ContactForm = () => {
    return(
    <div className='w-full max-w-xl my-2 mx-auto flex-none relative bg-white  '>
        ...
        <form id="contact" action="https://formsubmit.co/3801d72d81b553c61907efeb12c5c2d8 className=' w-full flex  items-center justify-center" method="post">
            ...
            <fieldset>
                ...
                <input className="bg-white border-b-2 border-[#888]" type="text" name="_honey" style={{ display: "none" }} />
            <fieldset>
